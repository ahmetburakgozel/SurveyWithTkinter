...
def set_Null():
    ...
    entry28.set(0)
    entry29.set(0)
    entry30.set("Boş bırakıldı")
    entry31.set("Boş bırakıldı")
    entry32.set("Boş bırakıldı")
    entry33.set("Boş bırakıldı")
    entry34.set("Boş bırakıldı")
    entry35.set("Boş bırakıldı")
    entry36.set("Boş bırakıldı")
    entry37.set("Boş bırakıldı")
    entry38.set("Boş bırakıldı")
    entry39.set("Boş bırakıldı")
    entry40.set("Boş bırakıldı")
    entry41.set("Boş bırakıldı")
    entry42.set("Boş bırakıldı")
    entry43.set("Boş bırakıldı")
    entry44.set("Boş bırakıldı")
    entry45.set("Boş bırakıldı")
    entry46.set(0)
    entry47.set(0)
    entry48.set(0)
    entry49.set(0)
...
set_Null()
Button(frame, text='Çıkış Yap', command=frame.quit).grid(row=5, column=15, pady=4)
Button(frame, text='Kaydet', command=submit_fields).grid(row=8, column=15, pady=4)
